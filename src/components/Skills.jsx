            ...
            <div className='flex flex-wrap justify-center gap-6'>
                {
                    skillsData.map((skill, index) => (
                        <div key={index} className='w-64 p-6 border bg-teal-50/10 border-teal-700 rounded-xl text-center cursor-pointer hover:border-b-4 hover:border-b-teal-800 hover:border-r-4 hover:border-r-teal-800 hover:-translate-y-1 transition-all duration:300'>
